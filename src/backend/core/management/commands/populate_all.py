...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        with io.StringIO() as out:
            ...
            populate_users_end_time = round((time.time() - populate_users_start_time), 2)
        ...
        with io.StringIO() as out:
            ...
            populate_products_end_time = round((time.time() - populate_products_start_time), 2)
        ...
        with io.StringIO() as out:
            ...
            populate_orders_end_time = round((time.time() - populate_orders_start_time), 2)
        ...
        with io.StringIO() as out:
            ...
            populate_reviews_end_time = round((time.time() - populate_reviews_start_time), 2)
        ...
        with io.StringIO() as out:
            ...
            populate_countries_end_time = round((time.time() - populate_countries_start_time), 2)
        ...
        with io.StringIO() as out:
            ...
            populate_sliders_end_time = round((time.time() - populate_sliders_start_time), 2)
