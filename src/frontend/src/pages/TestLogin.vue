<template>
  <div class="main">
    ...
    <div v-if="session" class="long">
      <p>
        Use the SDK's <code>toSession()</code> call to receive the session information, for example
...
// highlight-start
const basePath =
  process.env.VUE_APP_ORY_URL || 'https://gifted-driscoll-f20cnbrhvw.projects.oryapis.com'
...
export default {
  ...
  mounted() {
    ...
    fetch('https://gifted-driscoll-f20cnbrhvw.projects.oryapis.com/sessions/whoami', {
      headers: {
