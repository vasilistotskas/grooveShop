<template>
  ...
  >
    <div class="main-loader-icon">
      <svg height="194px" preserveAspectRatio="xMidYMid" viewBox="0 0 100 100" width="194px"
           xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
      >
        <g style="opacity:0.5">
          <polygon class="ldio-j8fbajw7p8s-st0" points="41.5 62 30 62 24.2 72 30 82 41.5 82 47.3 72" stroke="#ff0000" />
          <polygon class="ldio-j8fbajw7p8s-st0" points="58.8 72 47.3 72 41.5 82 47.3 92 58.8 92 64.6 82"
                   stroke="#ff0000"
          />
          <polygon class="ldio-j8fbajw7p8s-st0" points="76.2 62 64.6 62 58.8 72 64.6 82 76.2 82 81.9 72"
                   stroke="#ff0000"
          />
          <polygon class="ldio-j8fbajw7p8s-st0" points="41.5 42 30 42 24.2 52 30 62 41.5 62 47.3 52" stroke="#ff0000" />
          <polygon class="ldio-j8fbajw7p8s-st0" points="58.8 12 47.3 12 41.5 22 47.3 32 58.8 32 64.6 22"
                   stroke="#ff0000"
          />
          <polygon class="ldio-j8fbajw7p8s-st0" points="58.8 32 47.3 32 41.5 42 47.3 52 58.8 52 64.6 42"
                   stroke="#ff0000"
          />
          <polygon class="ldio-j8fbajw7p8s-st0" points="76.2 22 64.6 22 58.8 32 64.6 42 76.2 42 81.9 32"
                   stroke="#ff0000"
          />
        </g>
        <g>
          ...
          <path d="M43.9 42.8c-1.9 1.9-3.1 4.3-3.6 6.9l1.9 0.3c0.3-1.6 0.9-3 1.7-4.3l4.4 1.5l-1.5-4.4c1.3-0.9 2.7-1.5 4.3-1.7 l-0.3-1.9C48.2 39.7 45.8 40.9 43.9 42.8z"
                fill="#ff0000"
          />
          <animateTransform attributeName="transform" dur="4s" keyTimes="0;1" repeatCount="indefinite" type="rotate"
        ...
        <g class="ldio-j8fbajw7p8s-st2">
          <path d="M36 61.9c-1.7-3-2.7-6.4-2.7-9.9c0-10.9 8.8-19.7 19.7-19.7v1c-10.3 0-18.8 8.4-18.8 18.8 c0 3.3 0.9 6.5 2.5 9.4L36 61.9z"
                fill="#ff0000"
          />
          <animateTransform attributeName="transform" dur="2s" keyTimes="0;1" repeatCount="indefinite" type="rotate"
        ...
        <g class="ldio-j8fbajw7p8s-st2">
          <path d="M57 75.3l-0.5-3c9.9-1.7 17.2-10.2 17.2-20.3c0-11.4-9.2-20.6-20.6-20.6S32.5 40.6 32.5 52 c0 1.6 0.2 3.2 0.5 4.7l-3 0.7c-0.4-1.8-0.6-3.6-0.6-5.4c0-13.1 10.6-23.7 23.7-23.7S76.7 38.9 76.7 52 C76.7 63.6 68.4 73.4 57 75.3z"
                fill="#ff0000"
          />
          <animateTransform attributeName="transform" dur="1.332s" keyTimes="0;1" repeatCount="indefinite" type="rotate"
                            values="0 53.064 52;360 53.064 52"
          />
        </g>
        <g>
        ...
        >
          <animate attributeName="opacity" dur="1.332s" keyTimes="0;0.4;0.5;0.9;1" repeatCount="indefinite"
                   values="0;0;1;1;0"
          />
        </polygon>
        <g>
