<template>
  <div class="container" v-if="reviews && Object.keys(reviews).length > 0">
    <div class="user-reviews-grid">
      <div v-for="review in reviews" :key="review.id" class="user-review-card">
        <div class="user-review-product-image" v-bind:style="{ backgroundImage: 'url(' + review.product.main_image + ')' }">
<!--          <img :src="review.product.main_image" :alt="review.product.name" width="120">-->
        </div>
...
export default class Reviews extends Vue{
  ...
  public backgroundStars(productRate: any): string[] {
    ...
    console.log(this.isOddNumber(productRate))
