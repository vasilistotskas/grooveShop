...
import PaginationModel from '@/store/pagination/PaginationModel'
import { Action, Module, Mutation } from 'vuex-module-decorators'
import ProductReviewModel from '@/store/product/review/ProductReviewModel'
import router from '@/routes'

const toast = useToast()

@Module({
	name: 'Module/ProductReviewModule',
	namespaced: true,
	stateFactory: true
})
